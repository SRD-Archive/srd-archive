...
**Warlock:** You have made a deal with an otherworldly entity, granting
...
travelers carefully to judge if they are a threat. Its feathers are
...
target’s face, permanently damaging its visage and senses.
...
horses with a single long horn on its forehead. Timid, but proud and
willful, are seen as divine beings. Its hairs are worth small fortunes
...
Blast). Large humanoid beings with elongated arms. Live in forests,
...
**Name: X:** X HP, X Armor, X STR, X DEX, X WIL, Weapon (dX, special
items, qualities). Engaging descriptor of appearance or demeanor.
Quirk, tactic, or peculiarity making this NPC unique. Special effect or
...
has 6 (-2) Wisdom in 5e will have 8 WIL on Cairn.
...
You can use CR as a starting point; but consider the “levels of
threat.”
...
Combat turns represent tactical actions occurring over seconds or
minutes.
