...
**Basilisk:** 10 HP, 1 Armor, 12 STR, 13 DEX, 13 WIL, bite (d10)
...
**Buccaneer:** 4 HP, 11 STR, 14 DEX, 12 WIL, scimitar (d6)
...
**Centipede, Giant:** 1 HP, 6 STR, 3 WIL, sting (d6)
...
* 12’ humanoid statues forged of metal, fire, and magic. Wield massive
swords of iron.
...
**Lich:** 18 HP, 1 Armor, 18 WIL, soul dagger (d8)
...
* Arcane Epistle: You write a letter that only its intended reader can
understand.
* Arcane Fireworks: Target flame becomes a great conflagration of heat,
light and sound.
* Arcane Stain: Inscribes an invisible rune you can feel. Suffer 1d4
WIL loss if removed.
* Architect’s Eye: Any hidden doors within 60ft light up as if on fire.
* Architect’s Perfection: Create a holographic wall, floor, or ceiling
that looks absolutely real.
* Astral Step: You and anyone touching you instantly transport to a
known location you have been to before.
* Banishment: WIL save or creature to returns to native plane.
* Become Unseen: Target becomes invisible for 1 hour, and are still
able use abilities and attack without detection. Afterwards they become
incapacitated (deprived)
* Beguilement: Target humanoid must make a WIL save or is controlled
telepathically.
* Bewildering Fog: A hazy fog surrounds you in a radius of 20ft.
Attacks within the mist are impaired.
* Blazing Defense: You manifest a shield of flame (+1 Armor, 1d6
damage). Fire cannot hurt you.
* Blessing: Target’s attacks are enhanced and non-Blast attacks are
impaired against them until they next take damage.
* Bolster: A person you can see is emboldened by your words for a few
minutes: their attacks are enhanced and they cannot become deprived.
* Bound: Target can make a single jump to any place they can see.
* Boundless Message: Delivers a single sentence to any one creature
instantaneously, no matter the distance.
* Breath Soup: Blocks vision and slows movement.
* Burning Missile: You fire an acid missile that does 1d6 damage to a
target for every round it is not washed off.
* Burnishing Bubble: Target is enclosed by an impenetrable sphere that
rolls along the ground, unless they pass a DEX save.
* Calcify: Target object turns to stone at the caster’s touch. Living
targets save vs STR.
* Catsense: Target has heightened senses for the next hour, especially
at night.
* Chilling Graze: Target loses 1d4+1 STR and is deprived.
* Cinder Flesh: Energy beams burn enemies (1d10 blast damage) in a
straight line.
* Circle of Arcane Protection: Magical or godly beings cannot enter a
10ft circle.
* Cleanse: Rotten or poisoned food becomes edible.
* Cold Spray: A spray of cold air does d6 damage 20ft in one direction.
* Conceal Object: Masks an object against divination or scrying.
* Conquer Gravity: Target moves up or down according to your whims.
* Cosmic Fingertips: Your hands sculpt stone, rock or minerals into any
form you please.
* Coup de Grâce: An ally’s next attack ignores armor and takes damage
directly from their target’s STR.
* Craft from Clay: Any natural, earthen target is transformed (rock to
mud, lava to rock, etc).
* Create Unlife: Creates 1d4 undead skeletons and zombies from corpses.
WIL save every hour to control them.
* Curse of the Sightless: Anyone within eyesight must make a WIL save
or be blinded.
* Curse Unlife: Deals 1d4+2 STR loss to one undead, ignoring armor and
resistances.
* Cure-All: A single illness or disease dissipates at your touch.
* Cute Ink: A single page in a book can be altered to hide its true
content.
* Darksight: Target can see 60 ft. in total darkness.
* Death’s Breath: You summon a poisonous cloud (d6 STR loss) you can
control.
* Devil’s Comedian: WIL save or target laughs uncontrollably, unable to
take any action.
* Disaster Fluid: Anything in a 10ft square becomes slippery; DEX save
to avoid slipping.
* Disrupt Scry: Future divinations of one creature or object are misled
according to your will.
* Doppleganger: You spawn 1d6 decoy duplicates of someone you touch.
Decoys are dispelled with a touch.
* Doubleskin: Target humanoid doubles in size.
* Dreampoison: Target is deprived after suffering a night of bad
dreams.
* Dreamtalker: Sends a message to anyone currently asleep.
* Earsplit: Anyone within earshot is deafened.
* Easy Descent: Objects or creatures nearby fall very slowly.
* Edifice: You summon a stone wall up to 20ft wide that you can
control.
* Energize Rope: A rope-like objects moves at your command.
* Ensorcelled: Creatures are enraptured for a few minutes unless they
pass a WIL save.
* Envision: Spies on a target you have met, even across vast distances.
On a WIL save, they can feel your presence.
* Ephemeral Audio: Point to a spot. Anyone nearby hears a sound you
choose at any volume.
* Epidemic: Infects target with disease, which spreads until the source
of magic is destroyed.
* Extraplanar Convocation: Summons any extraplanar being onto your
plane. It holds no loyalty towards you or your allies.
* Extraplanar Request: Ask a single question of a random extraplanar
entity.
* Feline Dexterity: Target becomes limber, lithe and as fast as
quicksilver.
* Find Virulence: Detects poison in any creature or object within 30ft.
* Fire Curse: An object you touch is imbued with a hidden flame-trap
dealing 1d4+2 STR loss.
* Firey Missile: A bow you touch can fire flaming arrows (1d10 damage)
for one minute.
* Fish Lung: A target can breathe underwater until they surface again.
* Fleetfooted: One creature moves at double speed.
* Flicker: Target randomly vanishes and reappears once at will.
* Fog of Nausea: A cloud of nauseating vapors pours out from the
Spellbook’s pages. Anyone nearby makes a STR save or vomit
uncontrollably.
* Fold Portal: A door you touch opens into another door you’ve stepped
through before until it is shut again.
* Foolishness: A target you touch becomes vulnerable to wild mood
swings, sweeping conclusions and silly behavior. They also lose 1d6 WIL
for 24 hours (down to a minimum of 1).
* Fortify: Damage from heat, ice, acid or electricity are impaired
against a target for the next hour.
* Frozen Corpse: A corpse you touch is preserved.
* Gale: You summon an impenetrable wall of energy up to 15ft wide.
* Ghost Whisper: You and a sympathetic ally are linked, able to
converse in short sentences for an hour.
* Gift of Flight: Target can fly for a short while.
* Glacier: You create a wall of ice (15 HP, 3 Armor) around a creature
you choose.
* Gorgon’s Gaze: Target is transformed into a statue on a failed WIL
save. A success reverses the spell; holder must pass a WIL save or the
book is destroyed.
* Great Ball of Fire: You fire a ball of flame (1d10 damage) up to 20
feet away.
* Hand of the Protector: A giant, floating hand blocks all damage from
a single opponent until you are safe from danger.
* Healing Grace: A target heals 1d6 STR, and you become deprived until
you take the time to mediate, pray or sleep.
* Heatless Torch: Turns any object into a permanent, heatless torch.
* Hedgemagick: You perform a minor magical trick (create flame, wind,
light or sound).
* Hempen Hoop: A rope moves at your command.
* Hide Mind: The next person to scry your mind or your whereabouts is
fooled.
* Hoodwink Monster: Target monster makes a WIL save or treats you as an
ally.
* Hoodwink Person: Target becomes a friend until out of sight.
* Hovering Protection: A hovering, transparent disk materializes around
an ally granting 1 Armor.
* Ice Ray: Ice and snow flow from your fingerprints, dealing 1d8 damage
(blast) in a straight line.
* Icy Tempest: Hail deals 1d12 damage in a 20ft radius.
* Ill Fate: Target automatically fails next their next save.
* Illusory Landscape: You can make one type of terrain appear like
another.
* Incorporeal Shrug: Ignore any one attack.
* Induce Despair: Target must pass a WIL save or its attacks are
impaired.
* Induce Horror: Target makes a WIL save or flees.
* Inferno: You summon a flaming wall up to 15ft wide. Anyone passing
through suffers 1d6 STR loss.
* Influence: Target gains armor 3 but running and swimming are
impossible.
* Insubstantiate: Target becomes insubstantial and can float.
* Kraken’s Curse: Tentacles grapple all within 20 ft, STR save to break
free.
* Lamp’s Hue: Target object shines like a torch for one hour.
* Latch: An unlocked box, cabinet or door opens or closes at your
command.
* Librarian’s Trap: Deals 1d4+2 STR loss when read.
* Lichsense: You feel any undead within 60ft. WIL save to avoid
detection by intelligent undead.
* Light Show: You control a dazzling display of light and color.
* Lightning Strike: Electricity flings from your fingertips doing 1d12
damage (blast) in a line.
* Linguist: For the next hour you can speak and understand any mundane
language.
* Magic Seal: Magically locks a door, portal or chest.
* Major Genesis: Creates an object of nonliving stone or metal no
greater than 5 cubic foot in size.
* Maker: Transforms raw materials into finished items.
* Manic Fury: A target’s attacks are enhanced. They must make a WIL
save after a successful killing or lose control, attacking anyone in
sight.
* Masquerade: You assume the likeness of a similar creature you have
seen.
* Master Undead: Undead creatures obey your command. Intelligent undead
make a WIL save.
* Mental Tripwire: Intruders set off an alarm audible only to you.
* Mind Bond: Two allies can communicate via a mental link for the rest
of the day.
* Mind Reader: You can see or hear any person you have met before.
* Miniaturize: An object shrinks to one tenth its size.
* Minor Aegis: A target you touch ignores the next instance of harm
from a specific source.
* Minor Genesis: Creates an object of nonliving matter no greater than
one cubic foot in size.
* Mirage: You summon a noiseless & simple illusion of your choice.
* Molasses Veins: A single target moves at half speed.
* Murky Bubble: You create a bubble supernatural shadow within a 20ft
radius.
* Necrotic Touch: Target must DEX save or is paralyzed.
* Obfuscate: Target cannot be observed either through divination or
scrying.
* Obfuscation: Changes your appearance.
* Obscuring Mist: A rolling fog obscures vision in a 300ft radius.
* Opaque Cover: Details about your person become obscured and
unmemorable.
* Orb of Ignus: You control a floating ball of fire (1d8 damage) for a
short while.
* Orb of Immortality: Mundane attacks cannot harm anyone within a 10ft
radius, or vice-versa.
* Otherwordly Pet: Summons an unintelligent extraplanar creature up to
the size of a small dog. It holds no loyalty towards you or your
allies.
* Otherworldly Gate: Opens a portal to another reality. It works in
both directions.
* Paincurrent: An arc of electricity passes from your fingertips to a
target you touch. They take 1d8 damage (1d12 if wearing metal armor).
* Passage: Creates a temporary path through wood, stone or brick.
* Passive Invisibility: Target is invisible until they attempt harm.
* Peeping Warlock: You control a pair of floating eyes so long as yours
remain closed.
* Perfect Illusion: Creates an image with sound, smell and thermal
...
* Perfect Preservation: A weapon you touch becomes immune to wear,
mundane damage or elemental effects. The spell wears off after a day.
* Phantom Hound: A ghostly canine (4 HP, bite (1d4)) obeys your
commands for up to one hour.
* Phase Anchor: Binds an extraplanar creature to your will until it
performs a task specific task, after which they must pass a WIL save to
escape (good luck).
* Phase Sneak: Anyone within a 10ft radius is rendered invisible.
* Phase Touch: A disembodied, floating hand obeys your whims but is
immaterial. The next Spellbook, ability or item that relies on touch
now works from a distance.
* Philolomancy: You understand all spoken and written languages.
* Philosopher’s Mind: Target is immune to spiritual or psychic attacks,
as well as any attempts at mental or spiritual manipulation or
persuasion.
* Planar Anchor: Bars extradimensional movement.
* Plant Scourge: Plants within eyesight wither and die.
* Pocket Container: Summons a chest from an immaterial plane. It holds
up to 6 items. The chest is dismissed at will.
* Pocket Sun: You create a halo of bright light in a 60ft radius.
* Prisma Shard: An array of hypnotic lights fascinate nearby creatures,
unless they pass a WIL save.
* Profane Reveal: Target an empty space to reveal invisible objects or
creatures.
* Psychic Eye: Invisible floating eye allowing you to observe a single
location as present.
* Psychokinesis: Magically moves an object up to half your weight.
* Puppeteer: You can throw your voice a great distance away
* Purge Text: Mundane or magical writing vanishes at your touch.
* Pyramid of Passivity: Target creatures must make a DEX save or their
attacks are impaired.
* Pyschic Touch: You can hear target’s surface thoughts, so long as you
touch them.
* Rat-Tat-Tat: Loudly opens a locked or magically sealed door or chest.
* Ravenless Message: You send a short message 1 mile that anyone along
its path can hear.
* Reject Unlife: Nearby undead are immobilized for 30 seconds or until
you take another action.
* Remembered Voice: A spot you mark becomes the trigger for a
supernatural recording of your voice, delivering a short message of
your choice.
* Reverie: Targets become dazed for a moment, as if lost in daydream.
* Runic Harm: A rune you draw causes great pain to the reader, who must
WIL save or scream until they pass out (1d4 WIL loss). A successful
save destroys the rune.
* Runic Slumber: A rune you draw puts the reader into a magical sleep
that lasts 1d6 hours.
* Safe Haven: You summon a floating, invisible refuge for 8 hours. It
fits up to 8 people comfortably.
* Scintillate: Target must WIL save or their attacks become impaired.
* Scry Creature: Indicates the precise location of a familiar creature.
* Scry Object: Indicates the precise location of an object, known or
otherwise.
* Scrying Ward: For 24 hours you become aware of any magical
eavesdropping.
* Sculpt Water: Raise, lower or part nearby water.
* Secret Attaché: You summon an invisible creature of great power that
obeys your every command. Reading from other Spellbooks dispels the
creature.
* Shelter: Creates a standing edifice that can shelter up to 10
creatures, disappearing after 24 hours.
* Shrinking Cant: A humanoid creature you touch halves in size.
* Signal: Sends up a flare that can be seen for some distance.
* Simple Illusion: Creates a simple image with sound. A cursory
investigation will reveal the illusory image.
* Sinister Flame: Target’s palms are lined with flames (1d4+1 STR loss)
for one minute.
* Sinister Polymorph: WIL save or target is transformed into a harmless
animal.
* Skillfull Repair: You make minor repairs to a nonliving object.
* Sky Raft: You summon a 3ft wide floating disk that holds up to
100lbs.
* Solar Portal: Sends an extraplanar message to all beings that wish to
enter your plane. You have no choice which being answers and it holds
no loyalty to you or your allies.
* Song of Repose: Target falls into a deep slumber.
* Sonic Shattering: A sonic wave causes 1d6 STR loss to susceptible
objects or crystalline creatures, ignoring armor.
* Sorcerer’s Lock: Any door (magical or otherwise) is held shut until
you leave its vicinity.
* Soul Annex: Target’s spirit is caged within their body and replaced
...
* Steer’s Strength: Target’s strength triples; unarmed attacks are
enhanced.
* Strength Tap: A target you touch loses 1d6 STR, which is transferred
to you (up to your max STR).
* Stumbling Steps: A target you touch becomes deprived and loses 1 STR.
* Stupefaction: Target temporarily loses sense of place and time. WIL
save to overcome.
* Sudden Slumber: Target falls asleep for 1d4 hours.
* Summon Elemental: A being of fire, wire, earth, or wind manifests
from available matter to perform a single task for the caster. It
follows this command against its will.
* Sway Will: A target is compelled to follow a stated course of action,
without understanding why.
* Temporary Reprieve: Target regains any lost STR, but loses it again
after a few minutes.
* Terrify: Targets within eyesight must pass a WIL save or flee.
* Terrifying Illusion: A target is hunted by a terrible creature only
they can see. Its attacks do 1d12 damage; on Critical Damage they must
pass a WIL save or become catatonic.
* Thief’s Bane: An object appears trapped, even to an experienced
thief.
* Thwart the Elements: Damage from energy blasts are impaired against a
target for the next hour.
* Tongue of the Blue Serpent: Rust-colored, serpentine letters
materialize on a surface you choose. Anyone reading these words becomes
immobilized unless they succeed a WIL save.
* Torrential Moat: You summon a powerful wind that deflects arrows,
smaller creatures, and noxious gases.
* Toxic Blast: A small orb of acid deals 1d6 blast damage to a target.
* Transform Aura: Target’s aura is made non-magical or vice-versa.
* True Name: Determines the properties of a magical item you touch.
* Trueshift: A willing target takes on a new form (keeping only their
WIL), but must pass a WIL save to shift out.
* Twilight Steed: Summons an arcane steed that never tires, but
dissipates within daylight.
* Ultimate Sacrifice: The book’s holder transfer’s their life force
into a corpse, reviving both body and soul.
* Uncurse: A person or object you touch is freed from a curse or
nefarious spell.
* Undefinable Target: An ally becomes immune to mundane ranged attacks
for one round.
* Undeniable Courage: Target passes next WIL save and their attacks are
enhanced.
* Unflappable Endurance: Target does not take Fatigue from non-magical
activities or become deprived until their next rest.
* Vermin Plague: Summons a swarm of bats, rats, spiders or similar
creatures of your choice. They are harmless but distracting and hold no
loyalty towards you or your allies.
* Vines of Ichor: You spread sticky spiderwebs on the walls, floor and
ceilings within a 20ft radius.
* Warrior’s Edge: Target weapon is enhanced, and victim automatically
fails a critical damage save.
* Windborn: You direct a powerful wind in a straight line, strong
enough to blow over small boulders.
* Winter’s Woe: An icy storm assails multiple targets, obscuring
visibility and making the ground icy and treacherous.
* Witch Sight: Magical auras become visible to you for one hour.
* Wizard’s Exit: You and and anyone you touch can flee to safety at
double speed.
* Wizard’s Grasp: You control a phantasmal hand that can lift up to 5
pounds.
* Wizard’s Haven: A small, walled-in area cannot be scryed.
* Wizardsniff: You can feel any magic within a 60ft radius.
* Word of Pain: A single phrase from your lips does 1d12 blast damage.
Affected targets are also deafened.
