...
This is a revised markdown file for Cairn where tables were converted
to lists because tables reflow terribly.
...
1. **Lasting Scar:** Roll 1d6 &#124; 1: Neck, 2: Hands, 3: Eye, 4: 
Chest, 5: Legs, 6: Ear. Roll 1d6. If the total is higher than your max 
...
4. **Broken Limb:** Roll 1d6 &#124; 1-2: Leg, 3-4: Arm, 5: Rib, 6: 
Skull. Once mended, roll 2d6. If the total is higher than your max HP, 
take the new result.
